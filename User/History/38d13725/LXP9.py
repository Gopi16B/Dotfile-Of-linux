...
def PopupFunc(Bp):
        ...
        if Bp==True:
                ...
                lose_label=tk.Label(popup,text="Sorry, you lost! The word was:"+word,font=("Arial",14))
...
label=tk.Label(window,text=underscores,font=("Arial",27),bg="#1F2229")
label.grid(row=0,column=2,padx=10,pady=10)



messagebox=tk.Entry(window,width=10,font=("Arial",24),justify="center",bg="#1F2229",fg="black")
messagebox.grid(row=1,column=2,padx=30,pady=30)

messagebox.bind("<Return>", lambda event: SubAction())

submit=tk.Button(window,text="Submit",font=("Arial",14), command=SubAction,bg="#194B1B", fg="white", activebackground="#45a049")
submit.grid(row=2,column=2) 

result_text=tk.Label(window,text="",bg='#1F2229')
result_text.grid(row=3,column=2)


tries=len(word)-1
tries_text=tk.Label(window,text="tries left:"+str(tries),bg='#1F2229')
