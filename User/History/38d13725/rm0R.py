...
submit=tk.Button(window,text="Submit",font=("Arial",14), command=SubAction,bg="#194B1B", fg="white", activebackground="#194B1B", activeforeground="#26C02B",border=False,foreground='#194B1B')
