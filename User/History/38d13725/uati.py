...
label=tk.Label(window,text=underscores,font=("Arial",27),bg="#1F2229",fg='#ECEFF4',highlightbackground="#1f2229")
label.grid(row=0,column=2,padx=10,pady=10)



messagebox=tk.Entry(window,width=3,font=("Arial",24),justify="center",bg="#575858",fg="black")
