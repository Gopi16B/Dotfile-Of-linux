...
def PopupFunc(Bp):
        ...
        if Bp==True:
                win_label=tk.Label(popup,text="Congratulations! You guessed the word!",font=("Arial",14),bg="#1F2229",fg='#ECEFF4')
                win_label.pack(padx=20,pady=20)
                Again_button=tk.Button(popup,text="Play Again",command=ok,bg="blue",fg="white")
                Again_button.pack()
                Exit_button=tk.Button(popup,text="Exit",command=exit1,bg="red",fg="white")
                Exit_button.pack()
        else:
...
messagebox=tk.Entry(window,width=3,font=("Arial",24),justify="center",bg="#E5E9F0",fg="black")
